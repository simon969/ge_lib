...
class PlaxisScripting (object):
    def __init__(self, ps = None, host=None, port=None, password=None, log_file = None):
        ...
        if ps is None:
            ...
            if log_file is not None:
                ...
                plx_log_file = os.path.dirname(log_file) + r'\plx_logger.log'
                self.s_o.enable_logging(file=plx_log_file)
