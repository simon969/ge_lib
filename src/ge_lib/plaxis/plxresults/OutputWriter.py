...
def IsDbFile (self, db_file=None):   
        ...
        return retvar
def GetWriter(fileOut=None, tableOut=None, columns=None, formats=None, logger = None, mode = 'w'):
    
    if fileOut == None:
        return strWriter(columns, formats, logger)
    
    if IsDbFile(fileOut):
        return dbWriter (fileOut, tableOut,columns,formats, logger, mode)
    else:
        return csvWriter(fileOut, tableOut,columns,formats, logger, mode)
...
class dbWriter(writer):
    def __init__(self, fileOut=None, tableOut=None, columns=None, formats=None,logger=None, mode = 'w'
                    ):
